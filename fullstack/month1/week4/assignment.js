You are a front end developer for a supermarket and your task is to create a
product entry form to be used to capture product data. The form is supposed to 
...
array when the submit button is clicked

5. Display the array of products on thesame page under the form

6. Apply some CSS to make your work neat and nice
